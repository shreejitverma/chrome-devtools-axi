...
- Keep `.agents/skills/no-mistakes/SKILL.md` marked with `metadata.internal: true`; it is vendored for local agents and should stay hidden from public skill discovery.
