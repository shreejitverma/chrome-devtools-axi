...
The vendored `.agents/skills/no-mistakes/SKILL.md` is internal agent guidance; keep its `metadata.internal: true` frontmatter so skill discovery exposes only the public chrome-devtools-axi skill.
